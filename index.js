...
server.use(
  session({
    ...
    cookie: {
      maxAge: 1000 * 120, // expire the cookie after 2 minutes
      httpOnly: true, // disallow javascript from reading our cookie contents
    },
    resave: false, // avoid recreating sessions that have no changes
    saveUninitialized: false, // GDPR laws against setting cookies automatically
    store: new KnexSessionStore({
      knex: dbConfig,
      clearInterval: 1000 * 180, //  delete expired sessions every three minutes
